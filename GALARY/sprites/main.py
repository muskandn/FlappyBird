...
GAME_SPRITES={}
#GAME_SOUNDS={}
PLAYER='bird.png'#no need to use galary sprites......as both (main and 0 to 9 are in sprites)
...
if __name__=='__main__':
    ...
    GAME_SPRITES['numbers']=(
        pygame.image.load('0.png').convert_alpha(),#alpha makes easier to use the pictures in everyway or for quick bliting
